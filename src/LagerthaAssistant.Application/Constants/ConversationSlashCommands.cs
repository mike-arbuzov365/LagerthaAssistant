...
public static class ConversationSlashCommands
{
    ...
    public const string PromptPropose = "/prompt propose";
    public const string PromptImprove = "/prompt improve";
    public const string PromptApply = "/prompt apply";
    public const string PromptReject = "/prompt reject";
