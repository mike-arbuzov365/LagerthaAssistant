...
public interface IConversationRepository
{
    ...
    Task<ConversationSession?> FindSessionAsync(string userId, CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<ConversationSession>> GetAllClientSessionsAsync(string excludeUserId, CancellationToken cancellationToken = default);
