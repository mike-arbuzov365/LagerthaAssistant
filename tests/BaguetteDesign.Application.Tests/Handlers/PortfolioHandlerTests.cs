...
public sealed class PortfolioHandlerTests
{
    ...
    private sealed class FakePortfolioService : IPortfolioService
    {
        ...
        public Task<IReadOnlyList<string>> GetCategoriesAsync(CancellationToken ct = default) => Task.FromResult(_categories);
        public Task<IReadOnlyList<PortfolioCase>> GetByCategoryAsync(string category, CancellationToken ct = default) => Task.FromResult(_cases);
    }
