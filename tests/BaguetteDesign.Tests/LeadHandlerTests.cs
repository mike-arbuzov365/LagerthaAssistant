...
public sealed class LeadHandlerTests
{
    ...
    public async Task ShowLeadCard_ExistingLead_ShowsAllFields()
    {
        var lead = new Lead
        {
            ...
            AiSummary = "Packaging design for ACME"
        };
